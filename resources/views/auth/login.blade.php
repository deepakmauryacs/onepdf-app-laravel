...
<head>
  ...
  <style>
    ...
    .card-container { max-width: 500px; margin: 0 auto; border-radius: 0; box-shadow: 5px 5px 0 rgba(0,0,0,0.2); background:#fff; padding:3rem; animation: fadeIn 1s ease-in-out; }
    ...
    document.getElementById('loginForm').addEventListener('submit', async function(e){
      ...
      try {
        ...
        if (res.ok && result.success) {
          ...
          setTimeout(() => window.location = '{{ route('dashboard') }}', 1200);
        } else {
